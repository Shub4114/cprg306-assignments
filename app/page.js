  ...
  return (
    <main className=' flex flex-col items-center justify-center text-center min-h-screen '>
      ...
      <div className ='flex-col max-w-sm p-2'>
        ...
        <p className='font-bold font-bold rounded-full px-24 py-1 m-1'><Link href="week-3">Assignment week-3</Link></p>
        ...
        <p className='font-bold font-bold rounded-full px-24 py-1 m-1'><Link href="week-5">Assignment week-5</Link></p>
      </div>
    </main>
  );
};
